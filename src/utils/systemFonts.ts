...
const COMMON_WINDOWS_FONTS: WindowsFontDef[] = [
  ...
  { name: 'Arial Black', category: 'Display', tags: ['Display', 'Heavy', 'Bold'] },
  { name: 'Bahnschrift', category: 'Sans Serif', tags: ['Sans Serif', 'DIN', 'Variable'] },
  ...
  { name: 'Ebrima', category: 'Sans Serif', tags: ['Sans Serif', 'African', 'Clean'] },
  ...
  { name: 'Gadugi', category: 'Sans Serif', tags: ['Sans Serif', 'Native', 'Clean'] },
  { name: 'Georgia', category: 'Serif', tags: ['Serif', 'Web', 'Editorial'] },
  { name: 'Impact', category: 'Display', tags: ['Display', 'Bold', 'Poster', 'Heavy'] },
  { name: 'Ink Free', category: 'Handwriting', tags: ['Handwriting', 'Casual', 'Sketch'] },
  { name: 'Javanese Text', category: 'Serif', tags: ['Serif', 'Script', 'Asian'] },
  { name: 'Leelawadee UI', category: 'Sans Serif', tags: ['Sans Serif', 'UI', 'Clean'] },
  ...
  { name: 'Microsoft Himalaya', category: 'Serif', tags: ['Serif', 'Indic', 'Script'] },
  { name: 'Microsoft JhengHei', category: 'Sans Serif', tags: ['Sans Serif', 'Traditional Chinese', 'UI'] },
  { name: 'Microsoft Sans Serif', category: 'Sans Serif', tags: ['Sans Serif', 'Legacy', 'System'] },
  { name: 'Microsoft YaHei', category: 'Sans Serif', tags: ['Sans Serif', 'Simplified Chinese', 'UI'] },
  { name: 'Microsoft Yi Baiti', category: 'Sans Serif', tags: ['Sans Serif', 'Clean', 'Asian'] },
  { name: 'Mongolian Baiti', category: 'Serif', tags: ['Serif', 'Traditional', 'Asian'] },
  { name: 'MS Gothic', category: 'Sans Serif', tags: ['Sans Serif', 'Japanese', 'Monospace'] },
  { name: 'MS PGothic', category: 'Sans Serif', tags: ['Sans Serif', 'Japanese', 'Proportional'] },
  { name: 'MS UI Gothic', category: 'Sans Serif', tags: ['Sans Serif', 'Japanese', 'UI'] },
  { name: 'MV Boli', category: 'Handwriting', tags: ['Handwriting', 'Thaana', 'Script'] },
  { name: 'Myanmar Text', category: 'Sans Serif', tags: ['Sans Serif', 'Myanmar', 'Clean'] },
  { name: 'Nirmala UI', category: 'Sans Serif', tags: ['Sans Serif', 'Indic', 'UI'] },
  { name: 'Palatino Linotype', category: 'Serif', tags: ['Serif', 'Classical', 'Book'] },
  { name: 'Segoe Print', category: 'Handwriting', tags: ['Handwriting', 'Casual', 'Fluent'] },
  { name: 'Segoe Script', category: 'Handwriting', tags: ['Handwriting', 'Calligraphic', 'Fluent'] },
  ...
  { name: 'Symbol', category: 'Display', tags: ['Display', 'Math', 'Symbols'] },
...
export function getBundledSystemFonts(): FontItem[] {
  return COMMON_WINDOWS_FONTS.map((def) => ({
    ...
    version: 'Standard Windows System Font',
    license: 'Standard OS System Font License',
    folderId: def.category === 'Serif' ? 'serif' : def.category === 'Display' ? 'display' : def.category === 'Monospace' ? 'mono' : 'sans',
  }));
}
